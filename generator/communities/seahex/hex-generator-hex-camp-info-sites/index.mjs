...
function genSubAllocHex(res, base, digits, childNum) {
  ...
  while (res < 15) {
    res++;
    newDigits.push(res != 15 ? 6 : 2 + Math.floor(childNum / 7));
  }
...
let output = 'child_num,hex_id,dns_mapping\n'
const hex_id = 'gkgv6'; // Seattle
...
// console.log(output)
writeFileSync('../hex-camp-info-sites.csv', output);
