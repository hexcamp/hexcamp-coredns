...
_dnslink.{{ site.hex_reverse_path }}.h3.seahex.org. 600 IN TXT "dnslink=/ipfs/{{ site.dnslink_cid }}"
{{ site.hex_reverse_path }}.h3.seahex.org. 600 IN TXT "dnslink=/ipfs/{{ site.dnslink_cid }}"
{% endif %}
{% endfor %}
